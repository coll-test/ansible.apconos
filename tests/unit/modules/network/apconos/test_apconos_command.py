...
from ansible_collections.ansible.apconos.tests.unit.compat.mock import patch
from ansible_collections.ansible.apconos.plugins.modules import apconos_command
from ansible_collections.ansible.apconos.tests.unit.modules.utils import set_module_args
...
class TestApconosCommandModule(TestApconosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.apconos.plugins.modules.apconos_command.run_commands')
